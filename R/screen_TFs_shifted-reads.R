...
outPrefix <- file.path("results", paste0("v04_screen_TF_sr.", 
...
# reformat metadata
meta <- meta %>% 
  mutate(filePath = str_c(filePath, "-shifted-reads_allChr_chip.bed.sorted.bedGraph.bw")) %>% 
  mutate(name = paste0(TF, "_sr")) %>%
